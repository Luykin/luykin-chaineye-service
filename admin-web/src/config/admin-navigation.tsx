...
export const adminNavItems: AdminNavItem[] = [
  ...
  { key: "/admin-react/binance-square", icon: <LegacySidebarIcon name="square" />, label: "币安广场", group: "main" },
  ...
  { key: "/admin-react/version-stats", icon: <LegacySidebarIcon name="package" />, label: "版本统计", permission: "version-stats", group: "main" },
  { key: "/admin-react/url-stats", icon: <LegacySidebarIcon name="link" />, label: "接口统计", permission: "url-stats", group: "main" },
  ...
  { key: "/admin-react/messages", icon: <LegacySidebarIcon name="message" />, label: "站内消息", permission: "messages", group: "main" },
  { key: "/admin-react/reviews-management", icon: <LegacySidebarIcon name="message-circle" />, label: "点评管理", permission: "reviews-management", group: "main" },
  { key: "/admin-react/perf-monitor", icon: <LegacySidebarIcon name="zap" />, label: "性能监控", permission: "perf-monitor", group: "main" },
  { key: "/admin-react/server-command", icon: <LegacySidebarIcon name="server" />, label: "服务器命令", permission: "server:execute", group: "main" },
  ...
  { key: "/admin-react/nacos-messages", icon: <LegacySidebarIcon name="megaphone" />, label: "公告配置", permission: "nacos-messages", group: "main" },
  { key: "/admin-react/nacos-campaigns", icon: <LegacySidebarIcon name="target" />, label: "活动配置", permission: "nacos_config", group: "main" },
  { key: "/admin-react/nacos-tags", icon: <LegacySidebarIcon name="tag" />, label: "标签配置", permission: "nacos-tags", group: "main" },
