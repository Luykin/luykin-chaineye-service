...
export const adminNavItems: AdminNavItem[] = [
  ...
  { key: "/admin-react/notes", icon: <BookOutlined />, label: "备注查看", permission: "notes", group: "main" },
  { key: "/admin-react/log-search", icon: <FileSearchOutlined />, label: "日志搜索", permission: "log-search:read", group: "main" },
  ...
  { key: "/admin-react/data-export", icon: <ExportOutlined />, label: "数据导出", permission: "export:users", group: "main" },
  { key: "/admin-react/reviews-management", icon: <StarOutlined />, label: "点评管理", permission: "reviews-management", group: "main" },
  { key: "/admin-react/pro-management", icon: <ThunderboltOutlined />, label: "Pro 管理", permission: "pro-management", group: "main" },
  { key: "/admin-react/perf-monitor", icon: <DashboardOutlinedShim />, label: "性能监控", permission: "perf-monitor", group: "main" },
  { key: "/admin-react/backup", icon: <CloudOutlined />, label: "备份管理", permission: "backup:operate", group: "main" },
