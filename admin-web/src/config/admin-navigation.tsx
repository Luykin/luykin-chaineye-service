...
export const adminNavItems: AdminNavItem[] = [
  ...
  { key: "/nacos-security", icon: <LegacySidebarIcon name="shield" />, label: "Nacos安全检查", permission: ["security-check", "nacos_config"], group: "main", sidebarGroup: "monitor", implemented: true, section: "system" },
