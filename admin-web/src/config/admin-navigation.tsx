...
export const adminNavItems: AdminNavItem[] = [
  ...
  { key: "/twitter-id-handler", icon: <LegacySidebarIcon name="link" />, label: "Twitter ID转换", permission: "twitter-id-handler", group: "main", sidebarGroup: "operation", implemented: true, section: "primary" },
