...
const COLUMN_COMMENTS = {
  ...
  "EchohuntSocialListeningPosts": {
    ...
    "topics": "主题标签 JSON，由 Social Listening 调用 /ai/tweet_tag_v2 生成",
    "keywords": "热词与命中关键词 JSON，用于词云和命中原因",
    "summaryZh": "中文摘要，由 Social Listening 调用 /ai/tweet_summary_media 生成",
    "summaryEn": "英文摘要，由 Social Listening 调用 /ai/tweet_summary_media 生成",
    "titleZh": "中文标题，预留字段",
    "titleEn": "英文标题，预留字段",
    "abstractZh": "中文长摘要，预留字段",
    "abstractEn": "英文长摘要，预留字段",
    "tagStatus": "标签处理状态：generated/pending/failed/skipped",
    "summaryStatus": "摘要处理状态：generated/pending/failed/skipped",
    ...
    "aiSource": "AI 字段来源：social_listening_generated/project_attitude/mixed",
...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("EchohuntSocialListeningBoards", {
      ...
      status: { type: Sequelize.STRING(32), allowNull: false, defaultValue: "paused" },
