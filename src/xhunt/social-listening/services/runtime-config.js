...
function normalizeConfig(document = {}) {
  ...
  return {
    ...
    ai: {
      ...
      contentBatchSize: toInteger(getValue(merged, "ai.contentBatchSize", merged.ai.contentBatchSize), 10, 1, 50),
      projectAttitudeBatchSize: toInteger(getValue(merged, "ai.projectAttitudeBatchSize", merged.ai.projectAttitudeBatchSize), 20, 1, 100),
    ...
    alert: {
      ...
      negativeSpikeMinAnalyzed: toInteger(getValue(merged, "alert.negativeSpikeMinAnalyzed", merged.alert.negativeSpikeMinAnalyzed), 5, 1, 1000),
