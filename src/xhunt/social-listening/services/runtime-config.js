...
const DEFAULT_SOCIAL_LISTENING_RUNTIME_CONFIG = Object.freeze({
  ...
  ai: {
    ...
    maxTextLength: 1200,
    referenceContextMaxLength: 1200,
    longTextCondensationThreshold: 1800,
    longTextCondensationMaxLength: 1800,
    longTextCondensationConcurrency: 2,
...
function normalizeConfig(document = {}) {
  ...
  return {
    ...
    ai: {
      ...
      referenceContextMaxLength: toInteger(getValue(merged, "ai.referenceContextMaxLength", merged.ai.referenceContextMaxLength), 1200, 200, 2000),
      longTextCondensationThreshold: toInteger(getValue(merged, "ai.longTextCondensationThreshold", merged.ai.longTextCondensationThreshold), 1800, 500, 10000),
      longTextCondensationMaxLength: toInteger(getValue(merged, "ai.longTextCondensationMaxLength", merged.ai.longTextCondensationMaxLength), 1800, 900, 1800),
      longTextCondensationConcurrency: toInteger(getValue(merged, "ai.longTextCondensationConcurrency", merged.ai.longTextCondensationConcurrency), 2, 1, 4),
