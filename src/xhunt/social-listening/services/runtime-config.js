...
const DEFAULT_SOCIAL_LISTENING_RUNTIME_CONFIG = Object.freeze({
  ...
  ai: {
    ...
    longTextCondensationThreshold: 1200,
    longTextCondensationMaxLength: 900,
...
function normalizeConfig(document = {}) {
  ...
  return {
    ...
    ai: {
      ...
      longTextCondensationThreshold: toInteger(getValue(merged, "ai.longTextCondensationThreshold", merged.ai.longTextCondensationThreshold), 1200, 500, 10000),
      longTextCondensationMaxLength: toInteger(getValue(merged, "ai.longTextCondensationMaxLength", merged.ai.longTextCondensationMaxLength), 900, 200, 900),
