/**
 * 版本号比较工具
 * 版本号格式："0.2.05", "0.1.19", "0.1.23", "0.2.12"
 * 比较方式：去掉点，每个部分补零到2位，然后转换为数字比较
 * 例如："0.2.10" -> "000210" -> 210, "0.2.05" -> "000205" -> 205, 210 > 205
 */

/**
 * 将版本号转换为数字（用于比较）
 * @param {string} version - 版本号字符串，如 "0.2.05"
 * @returns {number} 版本号对应的数字，如 "0.2.05" -> 205
 */
