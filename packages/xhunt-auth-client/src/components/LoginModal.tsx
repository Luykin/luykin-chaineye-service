...
const ERROR_MESSAGES_EN: Record<string, string> = {
  ...
  IDENTITY_ALREADY_BOUND: "This account is already registered and cannot be linked to the current account.",
...
const ERROR_MESSAGES_ZH_CN: Record<string, string> = {
  ...
  IDENTITY_ALREADY_BOUND: "这个账户已注册，无法绑定到当前账户。",
...
const ERROR_MESSAGES_ZH_TW: Record<string, string> = {
  ...
  IDENTITY_ALREADY_BOUND: "這個帳戶已註冊，無法綁定到目前帳戶。",
